...
export const evidenceEnum = pgEnum("evidence_type", [
  "Training_Matrix_and_Schedule",
  "PAT_Testing",
  "Equipment_Calibration_Report",
  "Health_and_Safety",
  "Risk_Assessment",
  "Infection_Control_Audit",
  "Disability_Access_Audit",
  "Cleanliness_Audit",
  "Business_Continuity_Plan",
  "Prescribing",
  "Fire_safety_Report",
  "Palliative_Care_Register",
  "CQC_Compliance_Report",
]);
export const policyEnum = pgEnum("policy_type", [
  "Safeguarding_Policy",
  "Complaints_Policy",
  "Chaperoning_Policy",
  "Medicine_Management_Policy",
  "Repeat_Prescribing_Policy",
  "Locum_Policy",
  "Induction_Policy",
  "Human_Resources_Policy",
  "Human_Resources_Procedure",
]);
