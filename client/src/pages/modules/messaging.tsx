...
import { ArrowLeft, MessageSquare, Search, Plus, Send, Shield, Bell, Users, Radio, Settings } from "lucide-react";
...
export default function ChironMessaging() {
  ...
  const getContactName = (userId: string) => {
    ...
    return contact ? `${contact.firstName} ${contact.lastName}` : 'Unknown User';
  };

  const getContactInitials = (userId: string) => {
    const contact = contacts?.find(c => c.id === userId);
    return contact ? `${contact.firstName[0]}${contact.lastName[0]}` : 'U';
  };
          ...
          <div className="col-span-3 bg-white rounded-xl border border-slate-200 overflow-hidden">
            <div className="p-4 border-b border-slate-200">
              ...
              <div className="flex space-x-2">
                ...
                <Button size="sm" className="bg-chiron-blue hover:bg-blue-800" disabled>
              ...
              <div className="p-2 space-y-1">
                {conversations?.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-sm text-clinical-gray">No conversations yet</p>
                    <p className="text-xs text-clinical-gray">Start messaging with your team</p>
                  </div>
                ) : (
                  <>
                    ...
                    >
                      <div className="flex items-center space-x-3 mb-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-slate-900 truncate">Sister Jane Smith</p>
                          <p className="text-xs text-clinical-gray">2 mins ago</p>
                        </div>
                      </div>
                      <p className="text-sm text-clinical-gray truncate ml-11">Test results are ready for review...</p>
                    </div>
                    ...
                    >
                      <div className="flex items-center space-x-3 mb-1">
                        <div className="w-8 h-8 bg-chiron-orange rounded-full flex items-center justify-center">
                          <span className="text-white font-medium text-xs">MB</span>
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-slate-900 truncate">Mark Brown</p>
                          <p className="text-xs text-clinical-gray">1 hour ago</p>
                        </div>
                      </div>
                      <p className="text-sm text-clinical-gray truncate ml-11">Can we schedule a team meeting?</p>
                    </div>
                    ...
                    >
                      <div className="flex items-center space-x-3 mb-1">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium text-slate-900 truncate">Team Chat</p>
                          <p className="text-xs text-clinical-gray">Yesterday</p>
                        </div>
                      </div>
                      <p className="text-sm text-clinical-gray truncate ml-11">CQC inspection preparation...</p>
                    </div>
                  </>
                )}
              </div>
            ...
            {selectedConversation ? (
              <>
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-medical-green rounded-full flex items-center justify-center">
                      <span className="text-white font-semibold text-sm">
                        {selectedConversation === 'mock-1' ? 'SJ' :
                         selectedConversation === 'mock-2' ? 'MB' : 'TC'}
                      </span>
                    </div>
                    <div>
                      <h3 className="font-semibold text-slate-900">
                        {selectedConversation === 'mock-1' ? 'Sister Jane Smith' :
                         selectedConversation === 'mock-2' ? 'Mark Brown' : 'Team Chat'}
                      </h3>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  ...
                  <div className="flex">
                    ...
                    <div className="bg-slate-100 rounded-lg p-3 max-w-xs">
                      ...
                      <p className="text-xs text-clinical-gray mt-1">10:15 AM</p>
                    </div>
                  </div>

                  <div className="flex justify-end">
                    <div className="bg-chiron-blue text-white rounded-lg p-3 max-w-xs">
                      <p className="text-sm">Thanks! I'll review them now. Any urgent cases?</p>
                  ...
                  <div className="flex justify-center">
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-amber-800">Messages are monitored by AI safety system</span>
                      </div>
                    </div>
                  </div>
                ...
                <div className="p-4 border-t border-slate-200">
                  ...
                  {messageError && (
                    <p className="text-xs text-alert-red mt-2">{messageError}</p>
                  )}
                  <p className="text-xs text-clinical-gray mt-2">
                    Messages are encrypted and monitored for patient data protection
                  </p>
                </div>
              </>
            ) : (
              <div className="flex-1 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-clinical-gray">Choose a conversation from the sidebar to start messaging</p>
                </div>
              </div>
            )}
          </div>
            ...
            <div className="p-4 space-y-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-chiron-blue">System Maintenance</p>
                    <p className="text-xs text-blue-700 mt-1">Scheduled downtime Sunday 2-4 AM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-amber-800">CQC Inspection</p>
                    <p className="text-xs text-amber-700 mt-1">Preparation meeting tomorrow 3 PM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    <p className="text-sm font-medium text-green-800">New Staff Member</p>
                    <p className="text-xs text-green-700 mt-1">Welcome Dr. Emily Chen starting Monday</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-slate-200">
                ...
                <div className="space-y-2">
                  <Button variant="ghost" className="w-full justify-start text-sm text-clinical-gray hover:bg-slate-50" disabled>
