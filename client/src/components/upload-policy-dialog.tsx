...
export function UploadPolicyDialog({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!createdAt) {
      toast({
        title: "Missing date",
        description: "Please select when this policy was created",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      uploadPolicyMutation.mutate(policyData);
      setProgress(100);
    } catch (error) {
      ...
      <DialogContent className="sm:max-w-[525px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>
              Upload a policy document for practice compliance and reference.
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              ...
              <Textarea
                ...
                placeholder="Describe this policy (optional)"
                disabled={uploading}
                rows={3}
